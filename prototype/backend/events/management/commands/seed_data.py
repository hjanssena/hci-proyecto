...
from events.models import (
    Category, Event, Enrollment, Payment, Attendance,
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        e1 = Event.objects.create(
            ...
            end_date=(now + timedelta(days=50)).date(), schedule="Viernes 17:00 - 21:00, Sábados 09:00 - 13:00",
        ...
        e2 = Event.objects.create(
            ...
            end_date=(now + timedelta(days=25)).date(), schedule="Martes y Jueves 18:00 - 20:00",
        ...
        e3 = Event.objects.create(
            ...
            status=Event.Status.CONFIRMED, start_date=(now + timedelta(days=5)).date(),
            end_date=(now + timedelta(days=90)).date(), schedule="Sábados 09:00 - 14:00",
        ...
        e4 = Event.objects.create(
            ...
            end_date=(now + timedelta(days=4)).date(), schedule="09:00 - 17:00",
        ...
        e5 = Event.objects.create(
            ...
            end_date=(now + timedelta(days=15)).date(), schedule="Lunes y Miércoles 19:00 - 21:00",
        ...
        e6 = Event.objects.create(
            ...
            end_date=(now + timedelta(days=25)).date(), schedule="Lunes a Viernes 18:00 - 20:00",
        ...
        e7 = Event.objects.create(
            ...
            end_date=(now + timedelta(days=150)).date(), schedule="Viernes 16:00 - 20:00",
        ...
        e8 = Event.objects.create(
            ...
            end_date=(now + timedelta(days=22)).date(), schedule="Lunes a Viernes 09:00 - 11:00",
        ...
        e9 = Event.objects.create(
            ...
            end_date=(now + timedelta(days=42)).date(), schedule="09:00 - 18:00",
        ...
        e10 = Event.objects.create(
            ...
            end_date=(now + timedelta(days=65)).date(), schedule="Sábados 08:00 - 14:00",
        ...
        e11 = Event.objects.create(
            ...
            end_date=(now + timedelta(days=70)).date(), schedule="Miércoles 17:00 - 20:00",
        ...
        e12 = Event.objects.create(
            ...
            end_date=(now - timedelta(days=80)).date(), schedule="Lunes a Viernes 10:00 - 12:00",
        ...
        e13 = Event.objects.create(
            ...
            end_date=(now - timedelta(days=80)).date(), schedule="Sábados 09:00 - 14:00",
        ...
        e14 = Event.objects.create(
            ...
            end_date=(now - timedelta(days=90)).date(), schedule="Martes y Jueves 16:00 - 18:00",
        ...
        e15 = Event.objects.create(
            ...
            end_date=(now + timedelta(days=12)).date(), schedule="09:00 - 17:00",
        ...
        e16 = Event.objects.create(
            ...
            end_date=(now + timedelta(days=7)).date(), schedule="Sábado y Domingo 10:00 - 14:00",
